    ...
    return (
      <Segment basic hidden={this.props.hidden}>
        ...
        <div className="barcontainer">
          <div className="barcontainerheader">Mana Curve</div>
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(0) * 5}%` }}
          >
            <div className="barAmount">
              {this.cardsAtManaCost(0) > 2 && this.cardsAtManaCost(0)}
            </div>
            <div className="barlabel">0</div>
          </div>
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(1) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(2) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(3) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(4) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(5) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(6) * 5}%` }}
          >
            <div className="barAmount">
          ...
          <div
            className="bar"
            style={{ height: `${this.cardsAtManaCost(7) * 5}%` }}
          >
            <div className="barAmount">
